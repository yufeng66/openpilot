...
def moment_density_ceiling(centers):
  ...
  The steer distribution narrows as speed rises. Measured on the Palisade cache
  ...
  grid spans it. np.interp clamps outside the anchors, so a TOML speed_bp grid
  wider or narrower than the default stays well defined.
  """
